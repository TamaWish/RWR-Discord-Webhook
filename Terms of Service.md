...
These Terms of Service (“**Terms**”) govern download, installation, and use of the RWR-Discord plugin (“**Plugin**”). By using the Plugin, you agree to these Terms. If you do not agree, do not install or use it.
...
RWR-Discord is an optional add-on for ResourceWorldResetter. It listens to public RWR API events and delivers configured notifications to a Discord incoming webhook that **you** supply. It is not a hosted SaaS product and does not include guaranteed uptime, moderation, or Discord account services.

## 3. Eligibility and authority

You represent that you have authority to install plugins on the target Minecraft server and to configure a Discord webhook for the destination channel or server.
...
- A compatible ResourceWorldResetter runtime exposing `RwrApi`
- A reachable Discord webhook endpoint
...
THE PLUGIN IS PROVIDED “AS IS” AND “AS AVAILABLE,” WITHOUT WARRANTY OF ANY KIND, EXPRESS OR IMPLIED, INCLUDING BUT NOT LIMITED TO MERCHANTABILITY, FITNESS FOR A PARTICULAR PURPOSE, AND NON-INFRINGEMENT. WE DO NOT WARRANT THAT DELIVERY WILL BE UNINTERRUPTED, TIMELY, SECURE, OR ERROR-FREE.
...
You agree to indemnify and hold harmless the authors from claims arising out of your server configuration, Discord usage, player disputes, or violation of these Terms or applicable law—except to the extent caused by the authors’ willful misconduct where such limitation is not permitted.
...
Project repository: [https://github.com/TamaWish/RWR-Discord](https://github.com/TamaWish/RWR-Discord)
