package com.lozaine.resourceworldresetter.discord.command;
...
import com.lozaine.resourceworldresetter.discord.webhook.DeliveryStats;
...
/** Handles {@code /rwrdiscord reload} and {@code /rwrdiscord status}. */
public final class DiscordCommand implements CommandExecutor, TabCompleter {
    ...
    private void handleStatus(CommandSender sender, LocaleService locale) {
        ...
        DeliveryStats stats = webhooks == null ? new DeliveryStats() : webhooks.stats();
