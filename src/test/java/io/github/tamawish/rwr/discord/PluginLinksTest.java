...
class PluginLinksTest {
  ...
  void pointsAtPublicRepositoryDocs() {
    assertThat(PluginLinks.REPOSITORY).isEqualTo("https://github.com/TamaWish/RWR-Discord-Webhook");
    assertThat(PluginLinks.PRIVACY_POLICY)
        .isEqualTo("https://github.com/TamaWish/RWR-Discord-Webhook/blob/main/Privacy%20Policy.md");
