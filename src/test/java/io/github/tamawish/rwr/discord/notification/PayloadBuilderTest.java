...
class PayloadBuilderTest {
  ...
  void disablesMentionsWhenNotConfigured() {
    ...
    assertThat(root.getAsJsonObject("allowed_mentions").getAsJsonArray("parse")).isEmpty();
  ...
  void includesConfiguredUserMentions() {
    ...
    assertThat(root.getAsJsonObject("allowed_mentions").getAsJsonArray("users")).hasSize(1);
  }
